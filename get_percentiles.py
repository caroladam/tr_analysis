...
# Purpose: Calculate summary statistics (mean, variance, 5th and 95th percentiles) for allele lengths per locus.
# Input:
    # A tab-separated file where:
        # - First column contains locus identifier.
...
# Output:
    # A tab-separated file with columns: locus_id, mean, variance, percentile_5, percentile_95
# ---
